  ...
  return (
    <Layout>
      ...
      <div style={{
        ...
        <h1 style={{ margin: 0, color: '#fff', fontSize: '1.8rem', position: 'relative' }}>Art Gallery</h1>
        <p style={{ margin: '0.4rem 0 0', color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem', position: 'relative' }}>
          {content.length} lessons available · IAmanArtist India
        </p>
      </div>
        ...
        {filtered.map(item => (
          <div key={item._id} className="card">
            ...
            <div style={{ padding: '1rem' }}>
              ...
              >
                <PlayCircle size={15} /> View Lesson
              </Link>
            </div>
          </div>
        ))}
